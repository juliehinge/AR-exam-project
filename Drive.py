...
class ThymioController:
    def __init__(self):
        ...
        with ClientAsync() as client:
            ...
            async def prog(self, client, direction):
                """
                ...
                with await client.lock() as node:
                    ...
                    while True:
                        ...
                        if count > 5:
                            break
                        speed = self.turn(direction)
                        node.v.motor.left.target = speed[0]
                        node.v.motor.right.target = speed[1]
            ...
            client.run_async_program(prog(1))
